  ...
  return (
    <>
      <div style={{ marginBottom: '20px' }}>
        <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--text)' }}>RAG Policy</h2>
        <p style={{ fontSize: '12px', color: 'var(--muted)', marginTop: '3px' }}>
          Controls knowledge retrieval behaviour. One policy per assistant.
        </p>
      </div>
      ...
      {!selectedAssistant ? (
        ...
        >
          Select an assistant above to view and edit its RAG policy.
        </div>
      ) : (
        <div
          style={{
        ...
        >
          ...
          >
            <div style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text)' }}>
              🗃️ RAG Policy — {selectedAssistant}
            </div>
          </div>
          <div style={{ padding: '20px' }}>
            <RagPolicyTab assistantCode={selectedAssistant} />
          </div>
        </div>
      )}
    </>
