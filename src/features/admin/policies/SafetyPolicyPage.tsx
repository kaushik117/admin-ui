...
import { SafetyPolicyTab } from './SafetyPolicyTab'
  ...
  return (
    <>
      <div style={{ marginBottom: '20px' }}>
        <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--text)' }}>Safety Policy</h2>
        <p style={{ fontSize: '12px', color: 'var(--muted)', marginTop: '3px' }}>
          Content safety and runtime guardrail configuration per assistant.
        </p>
      </div>
      ...
      {!selectedAssistant ? (
        ...
        >
          Select an assistant above to view and edit its safety policy.
        </div>
      ) : (
        <div
          style={{
        ...
        >
          ...
          >
            <div style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text)' }}>
              🛡️ Safety Policy — {selectedAssistant}
            </div>
          </div>
          <div style={{ padding: '20px' }}>
            <SafetyPolicyTab assistantCode={selectedAssistant} />
          </div>
        </div>
      )}
    </>
